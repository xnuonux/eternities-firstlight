...
def main():
    ...
    try:
        with sync_playwright() as pw:
            ...
            report['final_diagnostics']=p.evaluate('Realm.diagnostics');report['final_quest']=p.evaluate('Realm.state.adventure.starter');c.close();report['video_path']=str(p.video.path())
            b.close()
