...
Retrieved and reconciled 2026-09-15. Dom asked to use Astra's new visions and specifically confirmed Earth, Heaven, Hell and Atlantis. These files are design sources, not additional authority to execute archived scripts, import old gameplay or settle open founder decisions.
...
|---|---|---|---|
| [Earth](https://drive.google.com/file/d/1hI0FVO3TVa34waL7VpGMSOjUpiNsQFcz/view) | The inhabited home: workshop, equipment, gardens, companion, music and ordinary consequences | E0/E1: inventory scene ownership, then connect Oren, the riverbank, lake/orchard and Bellweather approaches with measured rigid transforms and real ground. Preserve local combat coordinates. No payout in the geography gate. | Existing Firstlight remains the home. Connected-province work is next after spatial acceptance. Road After Rain is a later story gate. |
...
The next acceptance is human: walk the new road with a fresh and returning character in both cameras. Then reuse only the successful geometry/return contracts for Earth E0/E1, preserving the existing equipment outing and its once-only versus repeat rewards. Full Heaven, Hell and Atlantis content should keep their own bounded implementation gates.
