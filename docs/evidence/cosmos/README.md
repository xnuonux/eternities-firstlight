...
- `BROWSER_REPORT.json` records 74 production UI/input/storage/character checks. Screenshots are actual rendered Chromium frames. Browser source fixture overrides change only reduced-motion preferences.
