...
class EarthUI{
 constructor(rpg){this.rpg=rpg;this.story=new G.RealmEarthStoryUI.EarthStoryUI(rpg);this.ticket=null;this.reading=null;const root=document.createElement('div');root.id='earth-labels';root.setAttribute('aria-hidden','true');$('#hud').append(root);
